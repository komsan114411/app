...
const api = {
  ...
  async getInstallConfig(token) { return request('/api/install/config', { method: 'POST', body: { token } }); },
  async verifyAdminGate(token)  { return request('/api/admin-gate', { method: 'POST', body: { token } }); },
